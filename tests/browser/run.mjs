...
/**
 * Run the core smoke test inside a real browser via Playwright.
 *
 * Serves dist/ and test files via a local HTTP server, opens a headless
 * Chromium page that loads smoke-core.mjs as an ES module, and collects
 * the RunSmokeCore result.
 *
...
const HTML =
  "<!DOCTYPE html>\n<html>\n<head><title>pure-test browser smoke test</title></head>\n" +
  "<body>\n<script type=\"module\">\n" +
...
const server = createServer(async (req, res) => {
  ...
  // Serve the test harness HTML at a dedicated path
